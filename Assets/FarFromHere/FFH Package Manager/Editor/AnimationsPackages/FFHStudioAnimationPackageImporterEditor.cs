...
public class FFHStudioAnimationPackageImporterEditor : EditorWindow
{
    ...
    [MenuItem("FarFromHereStudio/ Packages Installer/ FullBody Rig System")]
    public static void Init()
    {

        FFHStudioAnimationPackageImporterEditor window = (FFHStudioAnimationPackageImporterEditor)GetWindow(typeof(FFHStudioAnimationPackageImporterEditor));
        window.Show();
    }
    ...
    static void Startup()
    {
        ...
        if (!data)
        {
            string[] assetPaths = AssetDatabase.FindAssets("FFHAnimationPackages");
